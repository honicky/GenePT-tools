...
class BatchInfo:
  ...
  def __init__(
    ...
    self.request_file_path = str(data_dir / "generated" / "batch-requests" /
                                 self.request_filename)
    self.response_filename = f"{batch_name}_responses.jsonl"
    self.response_file_path = str(data_dir / "generated" / "batch-requests" /
      ...
      "messages": [
        {
          "role":
            "system",
          "content":
            "You are a detail oriented bioinformatics and genetics expert help to give accurate and precise descriptions of genes",
        },
        {
          "role": "user",
...
def _create_batch_file(batch_info: BatchInfo, client: OpenAI) -> any:
  """
    ...
    """
  output_path = write_batch_requests_jsonl(batch_info.request_data,
                                           batch_info.request_filename,
                                           batch_info.data_dir)
